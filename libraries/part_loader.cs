...
namespace CO_Driver
{
    public class part_loader
    {
        ...
        public class Weapon
        {
            ...
            public int power_score { get; set; }
            public int weapon_class { get; set;}
        }
        ...
        public static Weapon new_weapon(string name, string desc, int rarity, int energy, double base_damage, int mass, int dura, int ps, int weapon_class)
        {
            return new Weapon
            {
                name = name,
        ...
        {
            Current_session.global_weapon_list.Add(new_weapon("CarPart_Gun_Machinegun_Starter", "SM Hornet", global_data.BASE_RARITY, 2, 2.71, 144, 60, 170, 1));
        }
